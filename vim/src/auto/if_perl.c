...
XS_EUPXS(XS_VIM_Buffers)
{
    ...
    SP -= items;
    {
#line 1122 "if_perl.xs"
    buf_T *vimbuf;
    int i, b;

#line 1343 "if_perl.c"
#line 1126 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
	{
...
XS_EUPXS(XS_VIM_Windows)
{
    ...
    SP -= items;
    {
#line 1173 "if_perl.xs"
    win_T   *vimwin;
    int	    i, w;

#line 1406 "if_perl.c"
#line 1177 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
